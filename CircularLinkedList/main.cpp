...
void title()
{
    ...
    drawstring(105.0, 250.0, (char *)"Sirius Thomas Mathew       4JK19CS053", 0, 0);
    drawstring(105.0, 220.0, (char *)"Omkaresh                   4JK18CS042", 0, 0);
    drawstring(200.0, 160.0, (char *)"Under the Guidance of", 3, 2);
    drawstring(205.0, 130.0, (char *)" Mr.Vijaykumar Dudhanikar", 0, 0);
    drawstring(270.0, 110.0, (char *)"Assistant Professor", 0, 1);
    drawstring(185.0, 90.0, (char *)"Department of Computer Science & Engineering", 0, 1);
    drawstring(105.0, 40.0, (char *)"Click Right Mouse Button for operations menu", 3, 0);
    glFlush();
}
